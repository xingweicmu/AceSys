        ...
        <tr>
          <td><div class="right_proaducts">
            ...
            <div class="biankuang_s">
              ...
              <div class="f_s1"></div>
      <form action="./products_search_showyk.jsp" method="post" name="form" id="form">          
              <div class="f_s3">
                <table width="400">
                  <tbody>
                    <tr>
        ...
        selected="selected">编号</option>
                          <option value="productname">西药</option>
                          <option 
        value="author">中药</option>
                          <option value="publisher">生化药</option>
                          <option 
        value="category">维生素</option>
                      </select></td>
