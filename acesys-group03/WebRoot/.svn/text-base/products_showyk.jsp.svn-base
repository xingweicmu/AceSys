...
<div id="content2">
  ...
  <table cellspacing="0" cellpadding="0" width="100%" border="0">
    <tbody>
      ...
      <a  class="table_t"  href="./register.jsp">注册</a>&nbsp;&nbsp;|</div></td>
       <td><div align="center"><a   href="./Product_Searchyk.jsp">商品查询</a></div></td>
       <td><div align="center"><a href="./cartshowyk.jsp">查看购物车</a></div></td>
      </tr>
    </tbody>
  </table>
  <div></div>
